...
// Event Loop состоит из Call Stack (Стек вызовов), Event Queque (Очередь задач - туда, например попадает fetch запрос, которфй ждет, пока Call Stack освободится) и Web API (DOM, SetTimeOut)
