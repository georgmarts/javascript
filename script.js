...
// Event Loop состоит из Call Stack (Стек вызовов), Event/Callback Queque (Очередь задач - туда, например попадает fetch запрос, которфй ждет, пока Call Stack освободится) и Web API (DOM, SetTimeOut)
